...
export default function Results() {
  ...
  return (
    <Layout hideFooter>
      <section className="relative overflow-hidden border-b border-[rgba(255,255,255,0.08)] bg-[#0A0A0A] text-[rgba(255,255,255,0.9)]">
        ...
        <div className="container py-12 md:py-16">
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              ...
              <h1 className="mt-4 text-3xl md:text-4xl font-bold" style={{ letterSpacing: '-0.03em' }}>
            ...
            <div className="w-full md:w-auto rounded-card border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.04)] px-5 py-4 backdrop-blur shadow-card">
              <p className="text-xs uppercase tracking-[0.2em] text-[rgba(255,255,255,0.5)]">Grand total</p>
              <p className="mt-2 text-2xl font-semibold font-mono text-[rgba(255,255,255,0.9)]" style={{ fontVariantNumeric: 'tabular-nums' }}>{formattedTotal}</p>
              <p className="mt-1 text-xs text-[rgba(255,255,255,0.5)]" style={{ fontVariantNumeric: 'tabular-nums' }}>
      ...
      <div className="bg-[#0A0A0A]">
        <div className="container py-8 md:py-12">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-card">
              <div className="flex items-start gap-3">
                <AlertCircle className="h-5 w-5 text-amber-400 flex-shrink-0 mt-0.5" strokeWidth={1.5} />
